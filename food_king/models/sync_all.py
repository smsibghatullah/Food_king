...
class food_king(models.Model):
   ...
   #  sync online order
    ...
    def get_online_order_from_api(self, cron_mode=True):
            ...
            Foodking_Ids_data = self.env['food_king.food_king'].sudo().search([])
            delivery_charges =  self.env['product.product'].sudo().search([('default_code', '=', 'delivery_charge_code')])
            for Foodking_Ids  in Foodking_Ids_data :
   ...
   #  update order
    ...
    def update_foodking_id_category(self, cron_mode=True):
        ...
        for Foodking_Ids  in Foodking_Ids_data :
                ...
                tax_url = f"{self.url or Foodking_Ids.url}/api/admin/setting/tax?paginate=1&page=1&per_page=100&order_column=id&order_type=desc"
                try:
                ...
                product_url = f"{self.url or Foodking_Ids.url}/api/admin/item?paginate=1&page=1&per_page=100&order_column=id&order_type=desc"
                try:
